const Works = () => {
  return (
    <>
      <div id="about"  className="text-center bg-[#071c2a] text-white mt-1 shadow-lg shadow-[#74f0ed]">

        <h1 className="sm:text-5xl text-3xl font-bold underline hover:decoration-[#74F0ed] sm:py-12 py-8 hover:text-[#74f0ed]">
          About Us
        </h1>
